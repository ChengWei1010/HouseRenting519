	...
	<section class="hero">
		<header>
			...
			<section class="caption">
				...
				<h3 class="properties">一切都在519學生租屋</h3><br><br><br><br><br><br><br><br><br><br><br><br>
				<h4><img src="img/scroll.png" alt=""></h4>
				SCROLL<br>DOWN
			</section>
	</section><!--  end hero section  -->

<!-- 搜尋表單 -->
	<section class="search" id="s1">
		<div class="wrapper">
			<form action="#" method="post">
				<input type="text" id="search" name="search" placeholder="在找什麼樣的房子？"  autocomplete="off"/>
